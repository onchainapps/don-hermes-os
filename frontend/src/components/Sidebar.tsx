...
export type AppId = 'CHAT' | 'CODE' | 'SYSTEM' | 'CRON' | 'SESSIONS' | 'WIKI' | 'HERMES' | 'PROFILES';
...
const APPS: AppDef[] = [
  { id: 'CHAT',      icon: Icons.chat,     label: 'Chat',      shortcut: '1' },
  { id: 'CODE',      icon: Icons.code,     label: 'Code',      shortcut: '2' },
  { id: 'SYSTEM',    icon: Icons.system,   label: 'System',    shortcut: '3' },
  { id: 'CRON',      icon: Icons.cron,     label: 'Cron Jobs', shortcut: '4' },
  { id: 'SESSIONS',  icon: Icons.sessions, label: 'Sessions',  shortcut: '5' },
  { id: 'WIKI',      icon: Icons.wiki,     label: 'Wiki 3D',   shortcut: '6' },
  { id: 'HERMES',    icon: Icons.hermes,   label: 'Hermes',    shortcut: '7' },
  { id: 'PROFILES',  icon: Icons.profiles, label: 'Profiles',  shortcut: '8' },
];
